...
const dicts = {
  mn: {
    ...
    hero: {
      ...
      headline2: "хөгжүүлж, хэрэглээнд нэвтрүүлнэ",
      sub: "Вэб, мобайл апп, хиймэл оюун, Odoo, дизайн, автоматжуулалт. Санааг тань нэг багаар хөгжүүлж, ашиглалтад оруулна.",
    ...
    services: {
      tag: "// Services",
      title: "Хөгжүүлэлтээс ашиглалт хүртэл нэг баг",
      sub: "Санаа, төлөвлөлт, хөгжүүлэлт, нэвтрүүлэлт, өргөтгөл — үе шат бүрийг нэг баг хариуцна.",
      ...
      items: [
        {
          ...
          description:
            "Серверээс хэрэглэгчийн дэлгэц хүртэл бүх хэсгийг хөгжүүлж, цаашид өргөжүүлэхэд бэлэн систем бүтээнэ.",
          features: [
            "TypeScript monorepo",
            "REST · GraphQL · tRPC",
            "Realtime · WebSocket",
        ...
        },
        {
          ...
          description:
            "Хиймэл оюунд суурилсан чат, хайлт, туслах болон автомат агентыг таны системд нэвтрүүлнэ.",
        ...
        },
        {
          ...
          description:
            "Үүлэн дэд бүтцийг төлөвлөж, ашиглалтад оруулна. Найдвартай ажиллагаа, хүчин чадал, зардлыг хамтад нь тооцно.",
        ...
        },
        {
          ...
          description:
            "Figma загварыг дэлгэц дээр ажиллах интерфэйс болгон хөгжүүлж, дизайны нарийн хэсгүүдийг хадгална.",
    ...
    products: {
      tag: "// Products",
      title: "Хэрэглээнд нэвтэрсэн SaaS бүтээгдэхүүнүүд",
    ...
    about: {
      ...
      p1: "Provision.mn нь 2019 онд үүсгэн байгуулагдсан. Бид таны санааг ажилладаг бүтээгдэхүүн болгож, бизнес өсөхөд системийг тань өргөжүүлэхэд тусална.",
      p2: "Вэб хөгжүүлэлт, хиймэл оюун, хэрэглэгчийн интерфэйс, автоматжуулалт — эдгээр ажлыг нэг багтай хамтран хэрэгжүүлнэ.",
      highlights: [
      ...
      stats: [
        { number: "60+", label: "Хэрэгжүүлсэн төсөл" },
        { number: "6", label: "Үндсэн хөгжүүлэгч" },
        { number: "10+", label: "Жилийн туршлага" },
        { number: "99.9%", label: "Тасралтгүй ажиллагааны зорилт" },
      ],
    },
    portfolio: {
      tag: "// Work",
      title: "Хэрэглээнд нэвтэрсэн төслүүдээс",
    ...
    contact: {
      ...
      brief: "Төслийн товч тайлбар",
      briefPlaceholder:
        "Юу бүтээх, хэзээ ашиглалтад оруулах, ямар боломжууд хэрэгтэйгээ бичээрэй...",
      submit: "Илгээх",
      projectTypes: [
        "Fullstack вэб",
        "Mobile app",
    ...
    process: {
      ...
      steps: [
        ...
        {
          title: "Ажлын хамрах хүрээг тохирох",
          body: "Хийх ажлууд болон нэмэлт өөрчлөлтөд тооцох зүйлсийг эхнээс нь бичгээр тохирно.",
        },
        {
          title: "Үе шаттай хүлээлгэн өгөх",
      ...
      hold: "Удаан дарж ажлын хүрээг баталгаажуулах",
      locked: "Ажлын хүрээ баталгаажлаа",
    },
    faq: {
      tag: "// FAQ",
      ...
      items: [
        ...
        {
          q: "Код хэнийх вэ?",
          a: "Код таны өмч. Эхний өдрөөс таны кодын санд хадгалагдана.",
        },
        {
